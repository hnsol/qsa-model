...
## A(4): Zetteldistillat（Z:D）の定義、原則、位置づけ (知能観ドキュメント反映版)

Zetteldistillat（以下、Z:D）は、**「情報の圧縮」と「意味の展開」の循環的プロセス**（参照: 知能観ドキュメント 1., 3.3）を知的活動の根幹と捉え、**LLMとの協働**を前提としてそのサイクルを効果的に回すために設計された、**意図駆動型の記録精製・構造化モデル**です。それは、静的な知識蓄積（Zettelkastenの限界）を超え、思考プロセスと実務的アウトプット創出をシームレスに接続することを目指します。
